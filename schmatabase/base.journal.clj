(grotte.data/make-row :post :id (java.util.UUID/fromString "9f99ccee-80da-4d29-819e-609ec637a57f")) ;1
...
(grotte.data/make-row :post :id (java.util.UUID/fromString "68b1ea82-5d8d-469e-afa8-3acc47d8cd69")) ;4
